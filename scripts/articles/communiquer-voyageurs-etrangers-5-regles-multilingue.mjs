export default {
  slug: 'communiquer-voyageurs-etrangers-5-regles-multilingue',
  title: 'Communiquer avec des voyageurs étrangers en LCD : 5 règles qui changent les avis',
  description: 'En LCD, 30-50% de tes voyageurs sont étrangers. Voici les 5 règles concrètes pour les rassurer, les guider et obtenir des avis 5 étoiles malgré la barrière linguistique.',
  keywords: 'voyageurs étrangers Airbnb, multilingue LCD, communication internationale Airbnb, langue voyageur',
  date: '2026-04-25',
  categorySlug: 'experience',
  readTime: 5,

  lead: 'Si tu loues sur Airbnb ou Booking, 30 à 50 % de tes voyageurs viennent de l\'étranger. Tu n\'es probablement pas trilingue. Pourtant, la qualité de la communication impacte directement l\'avis post-séjour. Voici les 5 règles pratiques pour bien communiquer même sans parler la langue.',
  ...
  related: [
    ...
    { slug: 'obtenir-avis-5-etoiles-airbnb',                    label: 'Obtenir 5 étoiles Airbnb',              categoryLabel: 'Expérience' },
  ],
}
