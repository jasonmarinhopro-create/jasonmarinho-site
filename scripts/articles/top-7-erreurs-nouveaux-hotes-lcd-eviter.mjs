export default {
  ...
  title: 'Top 7 des erreurs des nouveaux hôtes LCD (et comment les éviter)',
  description: 'Les 7 erreurs récurrentes des nouveaux hôtes Airbnb qui plombent leur démarrage. Listes des pièges, leurs conséquences chiffrées et comment les éviter.',
  keywords: 'erreurs hôte Airbnb débutant, pièges LCD nouveau, conseils démarrer location courte durée 2026',
  date: '2026-04-25',
  categorySlug: 'ressources',
  readTime: 6,

  lead: 'Sur 250 hôtes accompagnés à leurs débuts, 7 erreurs reviennent inlassablement. Elles coûtent en moyenne 2 000 à 5 000 € de manque à gagner sur les 6 premiers mois. Les éviter te fait gagner du temps, de la marge et des avis. Les voici dans l\'ordre de fréquence.',
  ...
  related: [
    ...
    { slug: 'erreurs-debutant-location-courte-duree-premier-logement', label: 'Erreurs débutant LCD',         categoryLabel: 'Ressources' },
    { slug: 'outils-gratuits-indispensables-demarrer-lcd-2026',  label: 'Outils gratuits LCD 2026',           categoryLabel: 'Ressources' },
  ],
}
