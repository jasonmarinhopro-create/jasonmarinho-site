  ...
  sections: [
    {
      ...
      content: [
        ...
        { type: 'p', text: 'Pour aller plus loin sur les obligations de protection des données associées à ton activité d\'hôte, regarde aussi notre guide sur la <a href="/blog/rgpd-donnees-voyageurs-airbnb-conformite" style="color:var(--g);font-weight:500">conformité RGPD pour les hôtes LCD</a>, qui détaille les bonnes pratiques de sécurisation des informations voyageurs que tu stockes au quotidien.' },
      ],
    },
    {
      h2: '2. Utilise un mot de passe unique et un gestionnaire dédié',
      content: [
        { type: 'p', text: 'La majorité des comptes Airbnb piratés ne tombent pas à cause d\'une attaque sophistiquée contre Airbnb, mais parce que l\'hôte a réutilisé le même mot de passe sur dix autres sites, et qu\'un de ces sites s\'est fait pirater. Les attaquants achètent ensuite les listes d\'identifiants sur le marché noir et testent automatiquement les combinaisons sur Airbnb, Booking, Gmail, Stripe, etc. C\'est ce qu\'on appelle le credential stuffing, et ça vise spécifiquement les hôtes parce que leurs comptes valent cher.' },
        { type: 'ul', items: [
        ...
        { type: 'tip', text: 'Bitwarden est gratuit pour un usage personnel et fonctionne sur tous les appareils. Tu génères un mot de passe unique de 20 caractères en un clic, tu n\'as plus qu\'à retenir le mot de passe maître du coffre. La courbe d\'apprentissage est d\'environ 15 minutes pour un bénéfice à vie.' },
      ],
    },
    {
      h2: '3. Apprends à reconnaître un email de phishing Airbnb',
      content: [
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'p', text: 'Cette règle vaut aussi pour la vérification du profil. Plusieurs hôtes ont été piégés par de faux voyageurs aux profils crédibles mais sans antécédent. Pour réduire ce risque, applique systématiquement les conseils de notre article sur la <a href="/blog/verification-voyageurs-avant-accepter-reservation-lcd" style="color:var(--g);font-weight:500">vérification d\'un voyageur avant d\'accepter sa réservation en LCD</a> avant chaque acceptation. Si tu veux à terme garder la main sur la relation et le paiement, le canal le plus sûr reste de développer ton propre <a href="/services/reservation-directe" style="color:var(--g);font-weight:500">canal de réservation directe sécurisé</a>, avec contrat de location et caution digitale séparés.' },
      ],
    },
    {
      h2: '5. Surveille les notifications de connexion et déconnecte les sessions inconnues',
      content: [
        { type: 'p', text: 'Airbnb t\'envoie un email à chaque connexion depuis un nouvel appareil ou un nouveau lieu géographique. C\'est ta sentinelle gratuite : si tu reçois un mail "Nouvelle connexion détectée à Sofia" alors que tu n\'as pas bougé de Lyon, c\'est qu\'un attaquant est entré dans ton compte malgré le mot de passe. Le délai de réaction compte parce qu\'il faut une dizaine de minutes à un pirate pour modifier ton email de récupération et te verrouiller dehors.' },
        { type: 'ul', items: [
        ...
        { type: 'tip', text: 'Crée un rappel récurrent dans ton calendrier tous les 3 mois : "Vérifier les sessions actives Airbnb, Booking et Stripe". Trente secondes par compte, et tu repères les accès oubliés d\'un ancien collaborateur ou d\'un appareil revendu sans déconnexion préalable.' },
      ],
    },
    {
      h2: '6. Réagis vite et bien si ton compte est compromis',
      content: [
        { type: 'p', text: 'Si malgré tout ton compte est piraté, chaque minute compte parce que les attaquants automatisent la suite : changement de mot de passe, changement d\'email de récupération, modification du compte bancaire de versement, et publication de fausses annonces pour encaisser de fausses réservations sous ta réputation. Plus tu agis vite, plus tu limites les dégâts financiers et le préjudice de réputation auprès de tes vrais voyageurs en cours.' },
        { type: 'ul', items: [
        ...
        { type: 'p', text: 'Garde toutes les preuves : captures d\'écran des emails suspects, des transactions anormales, des messages envoyés à ton insu, ainsi que les confirmations d\'échange avec le support Airbnb. Ces éléments te seront demandés pour la remise à zéro complète du compte et pour ton assurance si tu déclares un sinistre. Sur ce point, vérifie d\'ailleurs avant tout incident ce que couvre vraiment ton <a href="/blog/assurance-location-courte-duree-airbnb-couverture" style="color:var(--g);font-weight:500">contrat d\'assurance LCD en cas de fraude et de cyberattaque</a>, car le cyber-risque est souvent exclu des contrats habitation classiques.' },
      ],
    },
    {
      h2: 'Quinze minutes aujourd\'hui pour éviter des semaines de galère',
      content: [
        { type: 'p', text: 'Mettre en place ces 6 réflexes prend une quinzaine de minutes au total : activer la 2FA, changer le mot de passe avec un gestionnaire, lire deux exemples de phishing pour entraîner l\'œil, verrouiller les notifications, déconnecter les sessions inconnues et noter dans ton carnet la procédure d\'urgence à suivre en cas de compromission. C\'est probablement le meilleur retour sur temps investi de l\'année pour un hôte LCD, parce qu\'un compte piraté qui sert à frauder peut entraîner ta suspension le temps qu\'Airbnb démêle la situation, avec un manque à gagner immédiat sur les réservations futures.' },
        { type: 'p', text: 'Partager les bonnes pratiques de sécurité, repérer collectivement les nouvelles vagues d\'arnaques et alerter sur les emails frauduleux qui circulent fait aussi partie de ce qu\'on échange dans la <a href="/blog/communaute-lcd-groupes-hotes-entraide-facebook" style="color:var(--g);font-weight:500">communauté LCD d\'hôtes qui s\'entraident</a>. C\'est souvent là que tu apprendras qu\'une nouvelle campagne de phishing cible les hôtes français avant même qu\'Airbnb communique dessus.' },
        { type: 'cta', text: 'Tu veux échanger avec d\'autres hôtes sur la sécurité des comptes et les arnaques récentes ?', button: 'Rejoindre la communauté', href: '/services/communaute' },
      ],
    },
  ],
