export default {
  slug: 'photographe-airbnb-tarifs-comment-choisir',
  title: 'Photographe Airbnb : combien ça coûte et comment bien le choisir en 2026',
  description: "Tarifs constatés (150 à 500 €), retour sur investissement réel, critères pour choisir un photographe spécialisé LCD et erreurs à éviter. Guide complet par Jason Marinho.",
  keywords: 'photographe Airbnb, photographe location courte durée, tarif photographe immobilier, photos annonce Airbnb, photographe LCD',
  date: '2026-07-05',
  ...
  sections: [
    {
      h2: 'Pourquoi la photo est ton levier n°1 (avant le prix)',
      content: [
    ...
    {
      h2: 'Les tarifs constatés en 2026',
      content: [
    ...
    {
      h2: 'Le calcul de rentabilité (spoiler : il est vite plié)',
      content: [
        { type: 'p', text: "Prenons une session standard à 300 €. Avec une nuitée moyenne à 90 €, le shooting est amorti en 4 nuits vendues. À Paris ou sur la Côte d'Azur, c'est 2 à 3 nuits. Et ce n'est que l'amortissement sec : le vrai gain, c'est l'effet durable sur ton taux d'occupation et ton prix moyen." },
        { type: 'p', text: "Exemple concret : un T2 à 90 €/nuit qui passe de 60 % à 66 % d'occupation grâce à de meilleures photos gagne environ 160 € par mois. Sur un an, le shooting à 300 € a rapporté presque 2 000 €. Il n'y a pas beaucoup d'investissements en LCD avec ce niveau de retour." },
        { type: 'tip', text: "Les photos pro améliorent aussi ta visibilité locale : une fiche Google Business avec de belles photos attire plus de clics et de réservations directes. Si tu veux creuser ce levier, regarde le <a href='/services/gmb'>service Google My Business</a> de la plateforme." },
      ],
    },
    {
      h2: 'Photographe immobilier ou photographe LCD : la vraie différence',
      content: [
    ...
    {
      h2: 'Comment bien préparer le shooting',
      content: [
    ...
    {
      h2: 'Tu es photographe ? Ce marché est pour toi',
      content: [
        { type: 'p', text: "Dernier mot pour les photographes qui lisent ceci : la LCD est l'un des rares segments photo en croissance. Des centaines de milliers d'annonces en France, des hôtes qui comprennent enfin que la photo est un investissement, et très peu de photographes réellement spécialisés. Si tu maîtrises l'angle Airbnb, la lumière naturelle et la mise en scène voyageur, il y a une place à prendre dans ta ville." },
        { type: 'cta', text: "Fiche pro hébergée, demandes d'hôtes qualifiés dans ta zone, zéro commission sur tes prestations.", href: '/devenir-photographe-lcd', button: 'Devenir photographe LCD partenaire' },
      ],
    },
  ],

  related: [
    { slug: 'photographier-logement-location-courte-duree-smartphone', categoryLabel: 'Visibilité', label: 'Comment photographier son logement LCD soi-même (sans matériel pro)' },
    { slug: 'photo-couverture-airbnb-7-criteres-algo-computer-vision', categoryLabel: 'Visibilité', label: "Photo de couverture Airbnb : les 7 critères de l'algorithme" },
    { slug: 'photos-avant-apres-home-staging-lcd', categoryLabel: 'Visibilité', label: 'Photos avant/après : le home staging qui transforme une annonce LCD' },
  ],
}
