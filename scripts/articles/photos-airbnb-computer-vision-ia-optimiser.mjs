export default {
  slug: 'photos-airbnb-computer-vision-ia-optimiser',
  title: 'Photos Airbnb et Computer Vision : comment l\'IA juge tes images et ce qu\'il faut changer',
  description: 'Airbnb utilise une IA de Computer Vision pour analyser chaque photo de ton annonce. Qualité, cohérence, format : les critères exacts et les 5 actions pour améliorer ton score en 2026.',
  keywords: 'photos Airbnb Computer Vision, optimiser photos annonce Airbnb, IA analyse photos Airbnb 2026, qualité photos location courte durée, classement Airbnb photos',
  date: '2026-04-24',
  ...
  sections: [
    {
      h2: '1. Ce que la Computer Vision d\'Airbnb analyse exactement',
      content: [
        { type: 'p', text: 'L\'intelligence artificielle d\'Airbnb traite chaque photo comme un document de données. Elle détecte la présence d\'équipements mentionnés dans la description (lave-vaisselle, espace de travail, baignoire, vue panoramique), évalue la luminosité et la netteté de l\'image, et identifie l\'orientation (portrait vs paysage). Elle mesure aussi le taux de clic généré par chaque photo de couverture pour ajuster dynamiquement laquelle sera affichée en premier selon le profil du chercheur.' },
        { type: 'ul', items: [
          'Détection d\'équipements : si tu annonces "jacuzzi" sans photo de jacuzzi, l\'algo peut pénaliser',
          'Évaluation de luminosité : les photos sombres ou sous-exposées sont déclassées automatiquement',
          'Format : les photos en portrait (vertical) sont systématiquement dégradées par rapport aux photos en paysage',
          'Netteté : les photos floues ou pixelisées reçoivent un score visuel faible',
          'Cohérence titre/description/photos : l\'IA croise les trois pour détecter les incohérences',
        ]},
      ],
    },
    {
    ...
    {
      h2: '3. Les 5 actions concrètes pour améliorer ton score photo',
      content: [
        { type: 'p', text: 'Ces 5 actions peuvent améliorer significativement le score algorithmique de ton annonce sans nécessiter un photographe professionnel. L\'IA pénalise principalement les erreurs techniques corrigeables, pas le manque de matériel.' },
        { type: 'ul', items: [
          '1. Refais toutes les photos en format paysage (horizontal) avec un smartphone récent en lumière naturelle',
  ...
  related: [
    { slug: 'algorithme-airbnb-2026-criteres-classement',        label: 'Algorithme Airbnb 2026 : les 4 critères clés',   categoryLabel: 'Visibilité' },
