export default {
  slug: 'instagram-reels-tiktok-lcd-attirer-voyageurs',
  title: 'Instagram Reels & TikTok pour LCD : 6 formats vidéo qui convertissent',
  description: 'Les vidéos courtes Instagram et TikTok génèrent 3x plus d\'engagement que les photos pour la LCD. Voici 6 formats testés et la stratégie de publication.',
  keywords: 'Instagram Reels Airbnb, TikTok LCD, vidéo location courte durée, contenu vidéo hôte 2026',
  date: '2026-04-25',
  categorySlug: 'visibilite',
  readTime: 5,

  lead: 'Sur Instagram et TikTok en 2026, les vidéos courtes ont 3x plus d\'engagement que les photos statiques. Pour un hôte LCD, c\'est un canal d\'acquisition gratuit en croissance constante. Voici 6 formats vidéo qui convertissent vraiment, testés sur des comptes d\'hôtes français.',
  ...
  sections: [
    {
      ...
      content: [
        ...
        { type: 'ul', items: [
          'Structure : 0-5 sec accroche extérieure → 5-30 sec pièces principales → 30-55 sec détails différenciants → 55-60 sec CTA',
          'Voix off : parler naturellement, comme si tu montrais le logement à un ami',
          'Musique : douce en fond, pas de son fort qui couvre la voix',
          'Publication idéale : mercredi 18h-20h (pic de recherche logements de week-end)',
        ]},
      ],
    },
    {
      ...
      content: [
        ...
        { type: 'ul', items: [
          'Structure : 0-3 sec photo/vidéo de l\'avant → transition (bruit de marteau, son magique) → vidéo de l\'après',
          'Son effect "construction" ou "magic reveal" disponibles dans TikTok et Instagram nativement',
          'Même un home staging à 200 € peut donner un contenu "avant/après" très viral',
          'Hashtags : #beurenovation #homemaking #avantapres en plus des LCD',
        ]},
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'ul', items: [
          ...
          'Images : choisir des images du logement en lien avec ce que décrit l\'avis',
          'Demander l\'accord du voyageur avant d\'utiliser son avis en voix off publique (RGPD)',
        ]},
        { type: 'tip', text: 'Filme TOUJOURS en vertical 9:16 pour Instagram Reels et TikTok. Le format vertical est compatible YouTube Shorts en bonus.' },
        { type: 'cta', text: 'Tu veux développer ton compte Instagram et générer des réservations directes ?', button: 'Voir les formations', href: '/#formations' },
      ],
    },
  ],

  related: [
    { slug: 'instagram-hotes-lcd-attirer-voyageurs-reservations-directes', label: 'Instagram pour hôtes LCD',  categoryLabel: 'Visibilité' },
