...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .hero{background:linear-gradient(135deg,var(--g) 0%,var(--gd) 100%);color:#fff;padding:clamp(48px,7vw,80px) clamp(16px,5vw,60px) clamp(40px,6vw,72px)}
    ...
    .stats-strip{display:grid;grid-template-columns:repeat(4,1fr);gap:14px;max-width:920px;margin:-32px auto 0;padding:0 16px 0;position:relative;z-index:2}
...
<div style="max-width:920px;margin:-22px auto 0;padding:0 16px;position:relative;z-index:3">
  <a href="https://app.jasonmarinho.com/dashboard/simulateurs" style="display:flex;align-items:center;gap:14px;padding:14px 18px;background:linear-gradient(135deg,#fff 0%,rgba(255,213,107,.10) 100%);border:1px solid rgba(255,213,107,.40);border-radius:14px;box-shadow:0 6px 22px rgba(0,76,63,.08);text-decoration:none;color:inherit">
    <div style="width:36px;height:36px;border-radius:10px;background:linear-gradient(135deg,var(--y) 0%,var(--yd) 100%);display:flex;align-items:center;justify-content:center;flex-shrink:0;color:var(--gd);font-size:18px"><i class="ph-fill ph-house"></i></div>
    <div style="flex:1">
