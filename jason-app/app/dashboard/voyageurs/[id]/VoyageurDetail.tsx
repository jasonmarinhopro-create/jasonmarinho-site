                ...
                <div style={{ position: 'relative', zIndex: profileNatOpen ? 100 : 'auto' }}>
                  ...
                  {profileNatOpen && (
                    <div style={{
                      ...
                      // --surface est rgba(...,0.04) en mode sombre → invisible.
                      // --bg-2 est solide dans les deux modes.
                      ...
                      <div style={{ maxHeight: '200px', overflowY: 'auto' as const, background: 'var(--bg-2)' }}>
                        {COUNTRIES.filter(c =>
