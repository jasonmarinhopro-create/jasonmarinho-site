...
const s: Record<string, React.CSSProperties> = {
  ...
  /* ── Teasing : mesh gradient 2026 ── */
  teasing: {
    position: 'relative' as const, overflow: 'hidden' as const,
    maxWidth: '560px', margin: 'var(--s-10) auto 0',
    background: 'radial-gradient(ellipse 80% 60% at 100% 0%, var(--accent-bg-2), transparent 60%), var(--surface)',
    border: '1px solid var(--accent-border)',
    borderRadius: 'var(--r-2xl)', padding: 'clamp(36px,5vw,60px)',
    display: 'flex', flexDirection: 'column' as const, alignItems: 'center',
    gap: 'var(--s-5)', textAlign: 'center' as const,
  ...
  teasingTitle: {
    fontFamily: 'var(--font-fraunces), serif', fontSize: 'clamp(22px,3vw,30px)',
    fontWeight: 400, lineHeight: 'var(--lh-snug)', color: 'var(--text)', margin: 0,
