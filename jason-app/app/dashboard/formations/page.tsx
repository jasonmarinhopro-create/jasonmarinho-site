...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'GMB, tarification dynamique, fiscalité 2026, créer sa conciergerie, optimiser son annonce Airbnb… 20 formations pratiques pour la location courte durée.',
  ...
  twitter: {
    ...
    description: '20 formations pratiques pour la location courte durée.',
  },
