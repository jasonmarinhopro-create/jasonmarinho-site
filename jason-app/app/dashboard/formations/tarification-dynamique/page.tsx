...
export default async function FormationPage() {
  ...
  const { data: formation } = await supabase
    .from('formations')
    .select('id')
    .eq('slug', 'tarification-dynamique')
    .single()
  ...
  return (
    <>
      <Header title="Formation Tarification Dynamique" userName={profile?.full_name ?? undefined} />
      <FormationView
        formation={TARIFICATION_DYNAMIQUE_FORMATION}
