export const GMB_FORMATION = {
  slug: 'google-my-business-lcd',
  title: 'Google My Business pour la LCD',
  description: 'Attire des voyageurs directs sans passer par Airbnb grâce à Google. Optimise ta fiche, collecte des avis et génère des réservations sans commission.',
  duration: '2h30',
  level: 'Débutant',
  objectifs: [
