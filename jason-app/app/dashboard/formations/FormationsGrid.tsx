...
const styles: Record<string, React.CSSProperties> = {
  ...
  cardHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 'var(--s-4)' },
  cardIcon: {
    width: '52px', height: '52px', borderRadius: 'var(--r-lg)', flexShrink: 0,
  ...
  cardBadges: { display: 'flex', flexWrap: 'wrap' as const, gap: 'var(--s-1)', alignItems: 'flex-start', justifyContent: 'flex-end' },
  categoryBadge: {
    fontSize: 'var(--t-xs)', fontWeight: 600, letterSpacing: '0.5px',
  ...
  wip: {
    fontSize: 'var(--t-xs)', fontWeight: 700, letterSpacing: '0.7px', textTransform: 'uppercase' as const,
  ...
  cardTitle: {
    ...
    lineHeight: 'var(--lh-tight)', marginBottom: 'var(--s-3)',
    letterSpacing: 'var(--ls-snug)',
  },
  cardDesc: {
    fontSize: 'var(--t-sm)', fontWeight: 400,
    color: 'var(--text-2)', lineHeight: 'var(--lh-relax)',
    marginBottom: 'var(--s-4)', flex: 1,
  },
  meta: { display: 'flex', flexWrap: 'wrap' as const, gap: 'var(--s-3)', marginBottom: 'var(--s-5)' },
  metaItem: {
    display: 'flex', alignItems: 'center', gap: 'var(--s-1)',
    fontSize: 'var(--t-xs)', color: 'var(--text-3)',
  },
  progressArea: { marginBottom: 'var(--s-4)' },
  progressLabel: { fontSize: 'var(--t-xs)', color: 'var(--text-3)' },
  progressPct: { fontSize: 'var(--t-xs)', color: 'var(--accent-text)', fontWeight: 700, fontVariantNumeric: 'tabular-nums' as const },
  cardFooter: { paddingTop: 'var(--s-4)', borderTop: '1px solid var(--border)', marginTop: 'auto' },
  lockedBtn: {
