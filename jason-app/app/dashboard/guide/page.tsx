      ...
      <div style={styles.page}>
        <div style={styles.intro} className="fade-up">
          ...
          <p style={styles.pageDesc}>
            Tout ce qu&apos;il faut savoir pour réussir dans la location courte durée.
          </p>
        </div>
        ...
        <div style={styles.comingSoon} className="fade-up glass-card">
          ...
          <p style={styles.comingDesc}>
            Le Guide LCD arrive prochainement. Retrouvez ici les fondamentaux de la
            location courte durée : réglementation, fiscalité, décoration, gestion
            locative, et tous les conseils pour partir du bon pied.
          </p>
        </div>
      </div>
    </>
