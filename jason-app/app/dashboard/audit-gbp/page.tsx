...
const s: Record<string, React.CSSProperties> = {
  ...
  heroBadge: {
    ...
    border: '1px solid var(--info-border)',
    borderRadius: 'var(--r-pill)', padding: '5px 13px', marginBottom: 'var(--s-4)',
  },
  heroTitle: {
  ...
  pillarsRow: {
    display: 'flex', flexWrap: 'wrap' as const, gap: 'var(--s-2)',
    marginBottom: 'var(--s-5)',
  },
  pillarChip: {
    display: 'inline-flex', alignItems: 'center', gap: 'var(--s-2)',
  ...
  heroMeta: {
    ...
    fontSize: 'var(--t-xs)', color: 'var(--text-3)', flexWrap: 'wrap' as const,
  },
