...
export default async function Page() {
  ...
  // Strict role gating : seul un cleaner (ou admin) peut accéder à cette page.
  // Un hôte ou un photographe est redirigé vers son propre espace.
  ...
  if (role === 'photographer') redirect('/dashboard/ma-fiche-photographe')
    ...
    return (
      <div style={{ padding: 40, maxWidth: 720, margin: '0 auto', fontFamily: 'var(--font-outfit), sans-serif' }}>
        <h1 style={{ fontFamily: 'var(--font-fraunces), serif', fontSize: 24, marginBottom: 14 }}>
          Aucune fiche équipe ménage rattachée
        </h1>
        <p style={{ color: 'var(--text-muted)', lineHeight: 1.7, fontSize: 14 }}>
          Ton compte existe mais aucune fiche n'y est associée. Cela peut arriver si le paiement Stripe a été annulé.
