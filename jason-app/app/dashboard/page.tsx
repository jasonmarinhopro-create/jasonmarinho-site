...
const styles: Record<string, React.CSSProperties> = {
  ...
  welcome: {
    background: 'linear-gradient(135deg, rgba(0,76,63,0.2) 0%, rgba(255,213,107,0.04) 100%)',
  ...
  welcomeSub: { fontSize: '13px', color: 'rgba(240,244,255,0.4)', marginBottom: '4px' },
  welcomeTitle: { fontFamily: 'Fraunces, serif', fontSize: 'clamp(24px,3vw,32px)', fontWeight: 400, color: '#f0f4ff', marginBottom: '8px' },
  welcomeDesc: { fontSize: '14px', fontWeight: 300, color: 'rgba(240,244,255,0.5)', maxWidth: '400px' },
  statsRow: { display: 'flex', alignItems: 'center', gap: '20px', flexShrink: 0 },
  stat: { textAlign: 'center' },
  statVal: { display: 'block', fontFamily: 'Fraunces, serif', fontSize: '32px', fontWeight: 400, color: '#FFD56B', lineHeight: 1 },
  statLbl: { display: 'block', fontSize: '11px', color: 'rgba(240,244,255,0.4)', marginTop: '4px' },
  statDivider: { width: '1px', height: '36px', background: 'rgba(255,255,255,0.08)' },
  ...
  quickGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '12px' },
  quickCard: {
    display: 'flex', alignItems: 'center', gap: '14px',
    padding: '18px', textDecoration: 'none', borderRadius: '14px',
    transition: 'transform 0.2s',
  },
  quickIcon: { width: '40px', height: '40px', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  quickLabel: { fontSize: '14px', fontWeight: 500, color: '#f0f4ff', marginBottom: '2px' },
  ...
  emptyState: {
    ...
    display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px', borderRadius: '18px',
  },
  emptyTitle: { fontFamily: 'Fraunces, serif', fontSize: '20px', fontWeight: 400, color: '#f0f4ff' },
  emptyDesc: { fontSize: '14px', color: 'rgba(240,244,255,0.4)', maxWidth: '320px' },
}
