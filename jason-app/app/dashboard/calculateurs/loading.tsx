// Même skeleton que /dashboard/simulateurs : ActivityOverview + 3 tabs marché.
// Reuse pour cohérence visuelle entre les 2 pages soeurs.
export default function Loading() {
  return (
    <div style={s.page}>
      <div style={s.switcher}>
        <div style={{ ...s.bar, width: '160px', height: '32px', opacity: 0.5 }} />
        <div style={{ ...s.bar, width: '170px', height: '32px' }} />
      </div>

      <div style={{ ...s.bar, width: '140px', height: '20px', marginBottom: '14px' }} />
      <div style={{ ...s.bar, width: '300px', height: '40px', marginBottom: '10px' }} />
