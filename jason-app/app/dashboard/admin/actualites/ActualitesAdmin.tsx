...
const s: Record<string, React.CSSProperties> = {
  ...
  formWrap: { padding: 'var(--s-6)', borderRadius: 'var(--r-xl)' },
  form: { display: 'flex', flexDirection: 'column' as const, gap: 'var(--s-4)' },
  formTitle: { fontSize: 'var(--t-sm)', fontWeight: 700, color: 'var(--text-2)', textTransform: 'uppercase' as const, letterSpacing: '0.6px', marginBottom: 'var(--s-1)' },
  group: { display: 'flex', flexDirection: 'column' as const, gap: 'var(--s-2)' },
  label: { fontSize: 'var(--t-xs)', fontWeight: 600, color: 'var(--text-2)' },
  opt: { fontWeight: 400, color: 'var(--text-muted)' },
  input: {
    background: 'var(--surface)', border: '1px solid var(--border-2)',
    borderRadius: 'var(--r-md)', padding: '11px 14px',
    fontSize: 'var(--t-sm)', color: 'var(--text)', fontFamily: 'var(--font-outfit), sans-serif',
  ...
  publishLabel: {
    ...
    fontSize: 'var(--t-sm)', fontWeight: 400, color: 'var(--text-2)', cursor: 'pointer',
  },
  formActions: { display: 'flex', gap: 'var(--s-2)', justifyContent: 'flex-end', paddingTop: 'var(--s-1)' },
  cancelBtn: {
  ...
  filterRow: { display: 'flex', gap: 'var(--s-1)', flexWrap: 'wrap' as const },
  filterBtn: {
    display: 'inline-flex', alignItems: 'center', gap: 'var(--s-1)',
  ...
  empty: { padding: 'var(--s-12) var(--s-6)', textAlign: 'center' as const, fontSize: 'var(--t-base)', color: 'var(--text-muted)', borderRadius: 'var(--r-xl)' },
  list: { display: 'flex', flexDirection: 'column' as const, gap: 'var(--s-3)' },

  item: {
    padding: 'var(--s-5) var(--s-6)', borderRadius: 'var(--r-xl)',
    transition: 'border-color var(--d-base) var(--ease-smooth), box-shadow var(--d-base) var(--ease-smooth)',
  },
  itemHead: { display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 'var(--s-3)', marginBottom: 'var(--s-3)', flexWrap: 'wrap' as const },
  ...
  itemActions: { display: 'flex', alignItems: 'center', gap: 'var(--s-1)', flexShrink: 0 },
  iconBtn: {
  ...
  itemTitle: {
    ...
    fontSize: 'var(--t-lg)', fontWeight: 400, color: 'var(--text)',
    margin: '0 0 var(--s-2)', lineHeight: 'var(--lh-snug)',
    letterSpacing: 'var(--ls-snug)',
  },
  itemSummary: {
    fontSize: 'var(--t-sm)', fontWeight: 400, color: 'var(--text-2)',
    lineHeight: 'var(--lh-relax)', margin: '0 0 var(--s-3)',
  },
  itemSource: { display: 'inline-flex', alignItems: 'center', gap: 'var(--s-1)', fontSize: 'var(--t-xs)', color: 'var(--text-muted)', textDecoration: 'none' },
}
