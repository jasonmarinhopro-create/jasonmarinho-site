...
import { X, FilePdf, CaretDown, CaretUp } from '@phosphor-icons/react/dist/ssr'
...
export default function PrevisionnelModal({ result, paysLabel, typeLabel, nbChambres, modeLabel, onClose }: Props) {
