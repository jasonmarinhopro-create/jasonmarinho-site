      ...
      + '<li class="n-drop">'
        ...
        + '<div class="n-mega n-mega-3">'
          ...
          + '<div class="n-col">'
            ...
            + '<a href="/calculateurs/comparer-villes"><i class="ph ph-git-diff"></i>Comparateur de villes <span class="n-tag-free">Gratuit</span></a>'
  ...
  + '<div class="mob-menu" id="mob">'
    ...
    + '<div class="mob-acc" id="acc-sv">'
      ...
      + '<div class="mob-acc-body">'
        ...
        + '<a href="/calculateurs/comparer-villes"><i class="ph ph-git-diff"></i>Comparateur de villes</a>'
