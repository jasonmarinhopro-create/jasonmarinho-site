(function () {
  ...
  if (!document.getElementById('nav-styles')) {
    ...
    style.textContent = [
      ...
      /* Mobile menu */
      '.mob-menu{display:none;position:fixed;top:64px;left:0;right:0;bottom:0;background:var(--gd);border-top:1px solid rgba(255,213,107,.08);padding:12px clamp(16px,5vw,32px) 32px;z-index:199;flex-direction:column;overflow-y:auto;-webkit-overflow-scrolling:touch}',
      '.mob-menu.open{display:flex}',
      '.mob-section{padding:4px 0 8px;border-bottom:1px solid rgba(255,255,255,.04);margin-bottom:2px}',
      '.mob-section-title{font-size:10px;font-weight:600;letter-spacing:1.5px;text-transform:uppercase;color:rgba(255,213,107,.4);padding:8px 0 4px}',
      '.mob-menu a{font-size:15px;color:rgba(255,255,255,.55);text-decoration:none;padding:10px 0;display:flex;align-items:center;gap:10px;transition:color .2s;border-bottom:1px solid rgba(255,255,255,.03)}',
      '.mob-menu a:last-of-type{border-bottom:none}',
      '.mob-menu a:hover{color:#fff}',
      '.mob-menu a i{font-size:16px;color:rgba(255,213,107,.4);flex-shrink:0;width:16px;text-align:center}',
      '.mob-direct{padding:12px 0;border-bottom:1px solid rgba(255,255,255,.04) !important}',
      '.mob-ctas{display:flex;gap:8px;margin-top:16px;padding-top:16px;border-top:1px solid rgba(255,255,255,.05)}',
      '.mob-ctas a{flex:1;justify-content:center;font-size:14px;font-weight:500;text-decoration:none;padding:12px 0;border-radius:9px;display:flex;align-items:center;gap:5px;transition:all .2s}',
      '.mc-o{color:rgba(255,255,255,.65);border:1px solid rgba(255,255,255,.18)}',
      '.mc-o:hover{border-color:rgba(255,255,255,.35);color:#fff}',
      '.mc-c{color:var(--gd);background:var(--y);font-weight:600}',
  ...
  var h = '<nav id="nav">'
    ...
    + '<ul class="n-links">'
      ...
      + '<li class="n-drop">'
        ...
        + '<div class="n-mega">'
          + '<div class="n-col">'
            + '<div class="n-col-title">Par type d\'hébergement</div>'
            + '<a href="/pour-qui/chambres-dhotes"><i class="ph-regular ph-house-line"></i>Chambres d\'hôtes</a>'
            + '<a href="/pour-qui/conciergeries"><i class="ph-regular ph-buildings"></i>Conciergeries</a>'
            + '<a href="/pour-qui/gites"><i class="ph-regular ph-tree-evergreen"></i>Gîtes &amp; locations saisonnières</a>'
          + '</div>'
        + '</div>'
      + '</li>'
      ...
      + '<li class="n-drop">'
        ...
        + '<div class="n-mega">'
          + '<div class="n-col">'
            + '<a href="/blog"><i class="ph-regular ph-newspaper"></i>Blog LCD</a>'
            + '<a href="/ressources/gabarits-messages"><i class="ph-regular ph-chat-text"></i>Gabarits de messages</a>'
            + '<a href="/ressources/partenaires"><i class="ph-regular ph-handshake"></i>Partenaires recommandés</a>'
          + '</div>'
        + '</div>'
      + '</li>'
    ...
    + '</ul>'
    + '<div class="n-right">'
      + '<a href="https://app.jasonmarinho.com/auth/login" class="nb-o"><i class="ph-regular ph-user"></i> Mon espace</a>'
      + '<a href="https://app.jasonmarinho.com/auth/register" class="nb-c">Ouvrir un compte <i class="ph-bold ph-arrow-right"></i></a>'
    + '</div>'
  ...
  + '<div class="mob-menu" id="mob">'
    + '<div class="mob-section">'
      + '<div class="mob-section-title">Pour qui</div>'
      + '<a href="/pour-qui/chambres-dhotes"><i class="ph-regular ph-house-line"></i>Chambres d\'hôtes</a>'
      + '<a href="/pour-qui/conciergeries"><i class="ph-regular ph-buildings"></i>Conciergeries</a>'
      + '<a href="/pour-qui/gites"><i class="ph-regular ph-tree-evergreen"></i>Gîtes &amp; locations saisonnières</a>'
    + '</div>'
    ...
    + '</div>'
    + '<div class="mob-section">'
      + '<div class="mob-section-title">Ressources</div>'
      + '<a href="/blog"><i class="ph-regular ph-newspaper"></i>Blog LCD</a>'
      + '<a href="/ressources/gabarits-messages"><i class="ph-regular ph-chat-text"></i>Gabarits de messages</a>'
      + '<a href="/ressources/partenaires"><i class="ph-regular ph-handshake"></i>Partenaires recommandés</a>'
    + '</div>'
    + '<a href="/qui-suis-je" class="mob-direct"><i class="ph-regular ph-user-circle"></i>Qui suis-je</a>'
    + '<a href="/tarifs" class="mob-direct"><i class="ph-regular ph-tag"></i>Tarifs</a>'
    + '<div class="mob-ctas">'
      + '<a href="https://app.jasonmarinho.com/auth/login" class="mc-o">Mon espace</a>'
      + '<a href="https://app.jasonmarinho.com/auth/register" class="mc-c">Ouvrir un compte <i class="ph-bold ph-arrow-right"></i></a>'
    + '</div>'
  + '</div>';
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('click', function (e) {
      if (mob.classList.contains('open') && !mob.contains(e.target) && e.target !== hbg) {
        mob.classList.remove('open');
        hbg.classList.remove('open');
      }
    });

    /* Mega menu: click toggle (for touch / keyboard) */
