(function () {
      ...
      + '<li class="n-drop">'
        ...
        + '<div class="n-mega">'
          + '<div class="n-col">'
            ...
            + '<a href="/formations"><i class="ph ph-graduation-cap"></i>Voir toutes les formations</a>'
          ...
          + '<div class="n-col">'
            ...
            + '<a href="/services/groupes-facebook"><i class="ph ph-users-four"></i>Groupes Facebook</a>'
            + '<a href="/services/securite"><i class="ph ph-shield-check"></i>Sécurité des accès</a>'
            + '<a href="/services/partenaires"><i class="ph ph-handshake"></i>Partenaires</a>'
          + '</div>'
        + '</div>'
      + '</li>'
      ...
      + '<li class="n-drop">'
        ...
        + '<div class="n-mega">'
          + '<div class="n-col">'
            ...
            + '<a href="/ressources/partenaires"><i class="ph ph-handshake"></i>Partenaires recommandés</a>'
          + '</div>'
        + '</div>'
      + '</li>'
  ...
  + '<div class="mob-menu" id="mob">'
    ...
    + '<div class="mob-section">'
      ...
      + '<a href="/formations"><i class="ph ph-graduation-cap"></i>Toutes les formations</a>'
      + '<a href="/services/gmb"><i class="ph ph-map-pin"></i>GMB &amp; visibilité locale</a>'
      + '<a href="/services/annonce-directe"><i class="ph ph-megaphone"></i>Réservation directe</a>'
    + '</div>'
    + '<div class="mob-section">'
    ...
    + '<div class="mob-section">'
      ...
      + '<a href="/ressources/partenaires"><i class="ph ph-handshake"></i>Partenaires recommandés</a>'
    + '</div>'
    + '<a href="/qui-suis-je" class="mob-direct"><i class="ph ph-user-circle"></i>Qui suis-je</a>'
    + '<a href="/tarifs" class="mob-direct"><i class="ph ph-tag"></i>Tarifs</a>'
    + '<div class="mob-ctas">'
