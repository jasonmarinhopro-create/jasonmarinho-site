      ...
      + '<div class="ft-g">'
        ...
        + '<div>'
          ...
          + '<ul class="ft-ls">'
            ...
            + '<li><a href="https://driing.co" target="_blank" rel="noopener"><i class="ph ph-arrow-square-out"></i>Driing</a></li>'
          + '</ul>'
        + '</div>'
        + '<div>'
          + '<div class="ft-ct">Légal</div>'
          + '<ul class="ft-ls">'
            + '<li><a href="/mentions-legales"><i class="ph ph-file-text"></i>Mentions légales</a></li>'
            + '<li><a href="/politique-de-confidentialite"><i class="ph ph-shield"></i>Confidentialité</a></li>'
            + '<li><a href="/cgvu"><i class="ph ph-scroll"></i>CGV / CGU</a></li>'
          + '</ul>'
        + '</div>'
      + '</div>'
      + '<div class="ft-bot">'
