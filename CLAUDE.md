...
- Les champs libres rédigés par le bailleur (`conditions_annulation`, `reglement_interieur`) ne sont **pas** traduits automatiquement (impossible de garantir une traduction juridique fiable d'un texte libre) — affichés tels quels, dans la langue où le bailleur les a écrits, quel que soit le bouton sélectionné.
